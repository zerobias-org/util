...
export class Segment {
  ...
  */
  ...
  constructor(id: UUID, name: string, type: Nmtoken, ownerId: UUID, created: Date, updated: Date, status: CatalogPublishStatusEnumDef, latestVersionId: UUID, latestVersion: SegmentVersion, description?: string, parentId?: UUID, deleted?: Date, imageUrl?: URL, url?: URL, aliases?: Array<string>, boundaryId?: UUID, packageCode?: string, artifactId?: UUID, publishedArtifactName?: string, latestReleasedVersionId?: UUID) {
    this.id = id;
    this.name = name;
    this.type = type;
