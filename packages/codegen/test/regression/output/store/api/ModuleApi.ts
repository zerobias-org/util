...
Search terms may be separated by a space, in which case the search currently assumes a logical AND. * name&#x3D;&quot;resource projects search&quot; &#x3D;&gt; the name(s) must match resource project and search terms
   ...
   * @example
   * ```typescript
   * const result = await api.listOperations('00000000-0000-0000-0000-000000000000', 1, 1, null, 'name', null, null, null, true, null, null, 'pageToken');
   * ```
   * @openapi operation=listModuleOperations path=/modules/{moduleId}/operations method=GET
   * @memberof ModuleApi
   */
  listOperations(moduleId: UUID, pageNumber?: number, pageSize?: number, type?: OperationTypeParamDef, name?: string, status?: OperationStatusDef, method?: OpenApiMethodDef, keywords?: Array<string>, latest?: boolean, orderBy?: OrderByParamDef, sort?: SortParamDef, pageToken?: string): Promise<PagedResults<Operation>>;
...
Search terms may be separated by a space, in which case the search currently assumes a logical AND. * name&#x3D;&quot;resource projects search&quot; &#x3D;&gt; the name(s) must match resource project and search terms
   ...
   * @example
   * ```typescript
   * const result = await api.listModuleVersionOperations('00000000-0000-0000-0000-000000000000', 'version', 1, 1, 'name', null, null, '00000000-0000-0000-0000-000000000000', null, null, 'pageToken');
   * ```
   * @openapi operation=listModuleVersionOperations path=/modules/{moduleId}/versions/{version}/operations method=GET
   * @memberof ModuleApi
   */
  listModuleVersionOperations(moduleId: UUID, version: string, pageNumber?: number, pageSize?: number, name?: string, method?: OpenApiMethodDef, keywords?: Array<string>, productVersionId?: UUID, orderBy?: OrderByParamDef, sort?: SortParamDef, pageToken?: string): Promise<PagedResults<Operation>>;
   ...
   * @example
   * ```typescript
   * const result = await api.listVersions('00000000-0000-0000-0000-000000000000', 1, 1, true, true, 'pageToken');
   * ```
   * @openapi operation=listModuleVersions path=/modules/{moduleId}/versions method=GET
   * @memberof ModuleApi
   */
  listVersions(moduleId: UUID, pageNumber?: number, pageSize?: number, fileSupport?: boolean, dataSupport?: boolean, pageToken?: string): Promise<PagedResults<ModuleVersion>>;
   ...
   * @example
   * ```typescript
   * const result = await api.list(1, 1, null, null, true, true, null, null, 'pageToken');
   * ```
   * @openapi operation=listModules path=/modules method=GET
   * @memberof ModuleApi
   */
  list(pageNumber?: number, pageSize?: number, status?: ModuleStatusDef, packageNames?: Array<string>, fileSupport?: boolean, dataSupport?: boolean, orderBy?: OrderByParamDef, sort?: SortParamDef, pageToken?: string): Promise<PagedResults<Module>>;
   ...
   * @memberof ModuleApi
   */
  search(searchModuleBody: SearchModuleBody, pageNumber?: number, pageSize?: number, sort?: SortObject, pageToken?: string): Promise<PagedResults<ModuleSearch>>;
...
Search terms may be separated by a space, in which case the search currently assumes a logical AND. * name&#x3D;&quot;resource projects search&quot; &#x3D;&gt; the name(s) must match resource project and search terms
   ...
   * @openapi operation=listModuleOperations path=/modules/{moduleId}/operations method=GET
   */
  public async listOperations(moduleId: UUID, pageNumber: number = 1, pageSize: number = 50, type?: OperationTypeParamDef, name?: string, status?: OperationStatusDef, method?: OpenApiMethodDef, keywords?: Array<string>, latest: boolean = false, orderBy?: OrderByParamDef, sort?: SortParamDef, pageToken?: string): Promise<PagedResults<Operation>> {
    // verify required parameter 'moduleId' is not null or undefined
    if (moduleId === null || moduleId === undefined) {
      throw new ParameterRequiredError('moduleId');
    }
...
Search terms may be separated by a space, in which case the search currently assumes a logical AND. * name&#x3D;&quot;resource projects search&quot; &#x3D;&gt; the name(s) must match resource project and search terms
   ...
   * @openapi operation=listModuleVersionOperations path=/modules/{moduleId}/versions/{version}/operations method=GET
   */
  public async listModuleVersionOperations(moduleId: UUID, version: string, pageNumber: number = 1, pageSize: number = 50, name?: string, method?: OpenApiMethodDef, keywords?: Array<string>, productVersionId?: UUID, orderBy?: OrderByParamDef, sort?: SortParamDef, pageToken?: string): Promise<PagedResults<Operation>> {
    // verify required parameter 'moduleId' is not null or undefined
    if (moduleId === null || moduleId === undefined) {
      throw new ParameterRequiredError('moduleId');
    }
   ...
   * @openapi operation=listModuleVersions path=/modules/{moduleId}/versions method=GET
   */
  public async listVersions(moduleId: UUID, pageNumber: number = 1, pageSize: number = 50, fileSupport?: boolean, dataSupport?: boolean, pageToken?: string): Promise<PagedResults<ModuleVersion>> {
    // verify required parameter 'moduleId' is not null or undefined
    if (moduleId === null || moduleId === undefined) {
      throw new ParameterRequiredError('moduleId');
    }
   ...
   * @openapi operation=listModules path=/modules method=GET
   */
  public async list(pageNumber: number = 1, pageSize: number = 50, status?: ModuleStatusDef, packageNames?: Array<string>, fileSupport?: boolean, dataSupport?: boolean, orderBy?: OrderByParamDef, sort?: SortParamDef, pageToken?: string): Promise<PagedResults<Module>> {
    if (pageNumber) {
      await Int32.parse(pageNumber);
    }
    if (pageSize) {
   ...
   * @openapi operation=searchModules path=/moduleSearch method=POST
   */
  public async search(searchModuleBody: SearchModuleBody, pageNumber: number = 1, pageSize: number = 50, sort?: SortObject, pageToken?: string): Promise<PagedResults<ModuleSearch>> {
...
export class ModuleApiHttpImpl implements ModuleProducerApi {
  ...
  const _queryParams = {
      type,name,status,method,keywords,latest,orderBy,sort,
  };
  const _bodyParams = {
  ...
  const _queryParams = {
      name,method,keywords,productVersionId,orderBy,sort,
  };
  const _bodyParams = {
