...
export class NewPipelineJob {
  ...
  */
  ...
  constructor(pipelineId: UUID, previewMode: boolean, id?: UUID, executionStartTime?: DateTime, duration?: Duration, status?: PipelineJobStatusEnumDef, jobError?: object, previewCount?: number) {
