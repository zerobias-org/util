...
/**
* Describes an evidence request list object
*/
export class EvidenceRequestList {
  'id': UUID;
  'version': Semver;
  ...
  static getAttributeTypeMap() {
    return EvidenceRequestList.attributeTypeMap;
  }

  static newInstance(obj: any): EvidenceRequestList {
