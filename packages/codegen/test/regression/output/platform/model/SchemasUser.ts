...
*/
export class SchemasUser extends SchemasPrincipal {
  /**
  ...
  */
  ...
  static getAttributeTypeMap() {
    return super.getAttributeTypeMap().concat(SchemasUser.attributeTypeMap);
  }

  static newInstance(obj: any): SchemasUser {
    return ObjectSerializer.deserialize(obj, 'SchemasUser');
  }
