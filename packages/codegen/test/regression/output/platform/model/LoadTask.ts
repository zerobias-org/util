...
// ===============================================
import { EnumValue, IllegalArgumentError, UUID, DateTime } from '@zerobias-org/types-core-js';
...
export class LoadTask {
  ...
  constructor(status: LoadTask.StatusEnumDef, action: LoadTask.ActionEnumDef, txId: UUID, artifact: string, forced: boolean, startTime: DateTime, errorMessage?: string, errorStack?: string, endTime?: DateTime) {
    this.status = status;
    this.action = action;
    this.txId = txId;
