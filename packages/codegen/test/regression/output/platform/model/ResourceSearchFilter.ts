...
import { ComponentsSchemasCondition } from './ComponentsSchemasCondition.js';
...
export class ResourceSearchFilter {
  ...
  */
  'conditions'?: Array<ComponentsSchemasCondition>;
  ...
  */
  ...
  static attributeTypeMap: ReadonlyArray<{name: string, baseName: string, type: string, format: string}> = [
    ...
    },
    {
      ...
      "baseName": "conditions",
      // false
      // Array&lt;ComponentsSchemasCondition&gt;
      // Array&lt;ComponentsSchemasCondition&gt;
      "type": "Array<ComponentsSchemasCondition>",
      "format": ""
    },
    {
      "name": "alerts",
  ...
  constructor(types?: Array<Nmtoken>, keywords?: Array<string>, tags?: Array<Nmtoken>, inflate?: boolean, conditions?: Array<ComponentsSchemasCondition>, alerts?: AlertFilterDef, boundaryId?: Array<UUID>) {
    this.types = types;
