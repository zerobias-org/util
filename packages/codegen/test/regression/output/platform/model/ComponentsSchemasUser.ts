...
*/
export class ComponentsSchemasUser extends ComponentsSchemasPrincipal {
  /**
  ...
  */
  ...
  static getAttributeTypeMap() {
    return super.getAttributeTypeMap().concat(ComponentsSchemasUser.attributeTypeMap);
  }

  static newInstance(obj: any): ComponentsSchemasUser {
