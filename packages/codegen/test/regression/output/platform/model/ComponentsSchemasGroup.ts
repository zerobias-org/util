...
*/
export class ComponentsSchemasGroup extends ComponentsSchemasPrincipal {
  ...
  */
  ...
  static getAttributeTypeMap() {
    return super.getAttributeTypeMap().concat(ComponentsSchemasGroup.attributeTypeMap);
  }

  static newInstance(obj: any): ComponentsSchemasGroup {
