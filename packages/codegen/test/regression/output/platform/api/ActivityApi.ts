...
export interface ActivityApi {
   ...
   * @example
   * ```typescript
   * const result = await api.list(1, 1, null, 'search', null, null, 'pageToken');
   * ```
   * @openapi operation=listActivities path=/catalog/activities method=GET
   * @memberof ActivityApi
   */
  list(pageNumber?: number, pageSize?: number, sort?: SortObject, search?: string, resourceType?: Array<string>, activityType?: ActivityTypeEnumDef, pageToken?: string): Promise<PagedResults<ActivityExtended>>;
   ...
   * @example
   * ```typescript
   * const result = await api.listLinkTypes('00000000-0000-0000-0000-000000000000', 1, 1, 'pageToken');
   * ```
   * @openapi operation=listActivityLinkTypes path=/catalog/activities/{id}/linkTypes method=GET
   * @memberof ActivityApi
   */
  listLinkTypes(id: UUID, pageNumber?: number, pageSize?: number, pageToken?: string): Promise<PagedResults<SchemasLinkType>>;
...
export class ActivityApiMappingImpl implements ActivityApi {
   ...
   * @openapi operation=listActivities path=/catalog/activities method=GET
   */
  public async list(pageNumber: number = 1, pageSize: number = 50, sort?: SortObject, search?: string, resourceType?: Array<string>, activityType?: ActivityTypeEnumDef, pageToken?: string): Promise<PagedResults<ActivityExtended>> {
    if (pageNumber) {
   ...
   * @openapi operation=listActivityLinkTypes path=/catalog/activities/{id}/linkTypes method=GET
   */
  public async listLinkTypes(id: UUID, pageNumber: number = 1, pageSize: number = 50, pageToken?: string): Promise<PagedResults<SchemasLinkType>> {
