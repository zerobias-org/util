...
export interface ArtifactApi {
   ...
   * @example
   * ```typescript
   * const result = await api.listArtifactTypes(1, 1, 'pageToken');
   * ```
   * @openapi operation=listArtifactTypes path=/catalog/artifactTypes method=GET
   * @memberof ArtifactApi
   */
  listArtifactTypes(pageNumber?: number, pageSize?: number, pageToken?: string): Promise<PagedResults<string>>;
   ...
   * @example
   * ```typescript
   * const result = await api.listArtifactUpdates(1, 1, 'type', 'search', true, null, 'pageToken');
   * ```
   * @openapi operation=listArtifactUpdates path=/catalog/artifactUpdates method=GET
   * @memberof ArtifactApi
   */
  listArtifactUpdates(pageNumber?: number, pageSize?: number, type?: string, search?: string, deprecated?: boolean, days?: number, pageToken?: string): Promise<PagedResults<ArtifactVersion & ArtifactUpdate>>;
   ...
   * @example
   * ```typescript
   * const result = await api.listArtifacts(1, 1, 'type', 'search', true, null, null, 'pageToken');
   * ```
   * @openapi operation=listArtifacts path=/catalog/artifacts method=GET
   * @memberof ArtifactApi
   */
  listArtifacts(pageNumber?: number, pageSize?: number, type?: string, search?: string, deprecated?: boolean, days?: number, sort?: SortObject, pageToken?: string): Promise<PagedResults<ArtifactVersion>>;
...
export class ArtifactApiMappingImpl implements ArtifactApi {
   ...
   * @openapi operation=listArtifactTypes path=/catalog/artifactTypes method=GET
   */
  public async listArtifactTypes(pageNumber: number = 1, pageSize: number = 50, pageToken?: string): Promise<PagedResults<string>> {
    if (pageNumber) {
   ...
   * @openapi operation=listArtifactUpdates path=/catalog/artifactUpdates method=GET
   */
  public async listArtifactUpdates(pageNumber: number = 1, pageSize: number = 50, type?: string, search?: string, deprecated?: boolean, days?: number, pageToken?: string): Promise<PagedResults<ArtifactVersion & ArtifactUpdate>> {
    if (pageNumber) {
      await Int32.parse(pageNumber);
    }
    if (pageSize) {
   ...
   * @openapi operation=listArtifacts path=/catalog/artifacts method=GET
   */
  public async listArtifacts(pageNumber: number = 1, pageSize: number = 50, type?: string, search?: string, deprecated?: boolean, days?: number, sort?: SortObject, pageToken?: string): Promise<PagedResults<ArtifactVersion>> {
    if (pageNumber) {
      await Int32.parse(pageNumber);
    }
    if (pageSize) {
