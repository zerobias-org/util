...
export interface AlertApi {
   ...
   * @example
   * ```typescript
   * const result = await api.listAlerts(1, 1, '00000000-0000-0000-0000-000000000000', 'pageToken');
   * ```
   * @openapi operation=listAlerts path=/alerts method=GET
   * @memberof AlertApi
   */
  listAlerts(pageNumber?: number, pageSize?: number, triggerId?: UUID, pageToken?: string): Promise<PagedResults<AlertView>>;
   ...
   * @example
   * ```typescript
   * const result = await api.listLinkedResources('00000000-0000-0000-0000-000000000000', 1, 1, null, null, 'name', 'description', null, 'pageToken');
   * ```
   * @openapi operation=listLinkedResources path=/alerts/{id}/resources method=GET
   * @memberof AlertApi
   */
  listLinkedResources(id: UUID, pageNumber?: number, pageSize?: number, resourceTypes?: Array<Nmtoken>, alertResourceLinkTypes?: Array<Nmtoken>, name?: string, description?: string, sort?: object, pageToken?: string): Promise<PagedResults<AlertLinkExtendedResource>>;
   ...
   * @example
   * ```typescript
   * const result = await api.listResourcesImpactedByAlert('00000000-0000-0000-0000-000000000000', 1, 1, null, 'name', 'description', null, 'pageToken');
   * ```
   * @openapi operation=listResourcesImpactedByAlert path=/alerts/{id}/impacts method=GET
   * @memberof AlertApi
   */
  listResourcesImpactedByAlert(id: UUID, pageNumber?: number, pageSize?: number, resourceTypes?: Array<Nmtoken>, name?: string, description?: string, sort?: object, pageToken?: string): Promise<PagedResults<ResourceView>>;
   ...
   * @example
   * ```typescript
   * const result = await api.listTriggers(1, 1, 'pageToken');
   * ```
   * @openapi operation=listTriggers path=/alertTriggers method=GET
   * @memberof AlertApi
   */
  listTriggers(pageNumber?: number, pageSize?: number, pageToken?: string): Promise<PagedResults<AlertTriggerView>>;
...
export class AlertApiMappingImpl implements AlertApi {
   ...
   * @openapi operation=listAlerts path=/alerts method=GET
   */
  public async listAlerts(pageNumber: number = 1, pageSize: number = 50, triggerId?: UUID, pageToken?: string): Promise<PagedResults<AlertView>> {
    if (pageNumber) {
   ...
   * @openapi operation=listLinkedResources path=/alerts/{id}/resources method=GET
   */
  public async listLinkedResources(id: UUID, pageNumber: number = 1, pageSize: number = 50, resourceTypes?: Array<Nmtoken>, alertResourceLinkTypes?: Array<Nmtoken>, name?: string, description?: string, sort?: object, pageToken?: string): Promise<PagedResults<AlertLinkExtendedResource>> {
    // verify required parameter 'id' is not null or undefined
    if (id === null || id === undefined) {
      throw new ParameterRequiredError('id');
    }
   ...
   * @openapi operation=listResourcesImpactedByAlert path=/alerts/{id}/impacts method=GET
   */
  public async listResourcesImpactedByAlert(id: UUID, pageNumber: number = 1, pageSize: number = 50, resourceTypes?: Array<Nmtoken>, name?: string, description?: string, sort?: object, pageToken?: string): Promise<PagedResults<ResourceView>> {
    // verify required parameter 'id' is not null or undefined
    if (id === null || id === undefined) {
      throw new ParameterRequiredError('id');
    }
   ...
   * @openapi operation=listTriggers path=/alertTriggers method=GET
   */
  public async listTriggers(pageNumber: number = 1, pageSize: number = 50, pageToken?: string): Promise<PagedResults<AlertTriggerView>> {
    if (pageNumber) {
      await Int32.parse(pageNumber);
    }
    if (pageSize) {
...
export class AlertApiHttpImpl implements AlertProducerApi {
  ...
  const _queryParams = {
      resourceTypes,alertResourceLinkTypes,name,description,sort,
  };
  const _bodyParams = {
  ...
  const _queryParams = {
      resourceTypes,name,description,sort,
  };
  const _bodyParams = {
