...
public class HubModuleDocumentationGenerator extends DefaultCodegen implements CodegenConfig {
    public static final String PROJECT_NAME = "projectName";

    private final Logger LOGGER = LoggerFactory.getLogger(HubModuleDocumentationGenerator.class);
    ...
    protected String toMediaTypeSchemaName(String contentType, String mediaTypeSchemaSuffix) {
        if ("*/*".equals(contentType)) {
            return "SchemaFor" + mediaTypeSchemaSuffix + "Any";
        }
        return "SchemaFor" + mediaTypeSchemaSuffix + toModelName(contentType);
    }

    public HubModuleDocumentationGenerator() {
        super();
