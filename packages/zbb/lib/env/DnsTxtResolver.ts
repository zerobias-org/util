 ...
 */
export function getSearchDomain(): string | undefined {
  let content;
  try {
 ...
 */
export async function lookupDnsTxt(prefix: string): Promise<Record<string, string> | undefined> {
 ...
 */
export async function resolveDnsEnv(prefix: string): Promise<Map<string, string>> {
